...
const DEFAULT_PRODUCTS = [
    { id: 1, name: "Кофе", price: 250, desc: "Свежий кофе", categoryId: 2, image: "", active: true, hidden: false, isRecommended: true },
    { id: 2, name: "Чай", price: 150, desc: "Ароматный чай", categoryId: 2, image: "", active: true, hidden: false, isRecommended: false },
    { id: 3, name: "Бургер", price: 390, desc: "Сочная котлета и соус", categoryId: 1, image: "", active: true, hidden: false, isRecommended: true },
    { id: 4, name: "Чизкейк", price: 320, desc: "Нежный десерт", categoryId: 3, image: "", active: true, hidden: false, isRecommended: false }
];
...
function renderShop() {
    ...
    mainContent.innerHTML = `
        <div class="banner">
            ...
            <p>Категории, промокоды и быстрый заказ в Telegram Mini App.</p>
